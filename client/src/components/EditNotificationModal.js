...
const EditNotificationModal = ({ isOpen, onClose, notification, onSuccess }) => {
  ...
  useEffect(() => {
    if (isOpen && notification) {
      setFormData({
        ...
        targetUserId: notification.targetUserId?._id || '',
        showOnHome: notification.showOnHome || false,
        isHomeNotification: notification.isHomeNotification || false,
    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-charcoal border border-lava-orange/30 rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-bold neon-text-cyan">Edit Notification</h2>
