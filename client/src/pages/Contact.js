        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-charcoal border border-lava-orange/30 rounded-lg p-4 sm:p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@tournament.com" className="text-off-white hover:text-lava-orange transition-colors">
            ...
            <div className="flex space-x-4">
              <button className="w-12 h-12 bg-lava-black border border-lava-orange/30 rounded-lg flex items-center justify-center hover:bg-lava-orange hover:text-lava-black transition-colors" aria-label="Discord">
                <span className="text-xl">💬</span>
              </button>
              <button className="w-12 h-12 bg-lava-black border border-lava-orange/30 rounded-lg flex items-center justify-center hover:bg-lava-orange hover:text-lava-black transition-colors" aria-label="YouTube">
                <span className="text-xl">▶️</span>
              </button>
              <button className="w-12 h-12 bg-lava-black border border-lava-orange/30 rounded-lg flex items-center justify-center hover:bg-lava-orange hover:text-lava-black transition-colors" aria-label="Instagram">
                <span className="text-xl">📷</span>
              </button>
              <button className="w-12 h-12 bg-lava-black border border-lava-orange/30 rounded-lg flex items-center justify-center hover:bg-lava-orange hover:text-lava-black transition-colors" aria-label="Twitter">
                <span className="text-xl">🐦</span>
              </button>
            </div>
            </div>
